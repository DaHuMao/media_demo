...
#include "sdk/android/native_api/jni_zero/common_apis.h"

#include "sdk/android/native_api/jni_zero/generate_jni/JniUtil_jni.h"
#include "sdk/android/native_api/jni_zero/system_jni/Arrays_jni.h"
#include "sdk/android/native_api/jni_zero/system_jni/Boolean_jni.h"
#include "sdk/android/native_api/jni_zero/system_jni/Collection_jni.h"
#include "sdk/android/native_api/jni_zero/system_jni/Integer_jni.h"
#include "sdk/android/native_api/jni_zero/system_jni/List_jni.h"
#include "sdk/android/native_api/jni_zero/system_jni/Long_jni.h"
#include "sdk/android/native_api/jni_zero/system_jni/Map_jni.h"

namespace jni_zero {

ScopedJavaLocalRef<jobjectArray> CollectionToArray(
    JNIEnv* env, const JavaRef<jobject>& collection) {
...
ScopedJavaLocalRef<jobject> ListGet(JNIEnv* env, const JavaRef<jobject>& list,
                                    jint idx) {
  return JNI_List::Java_List_get(env, list, idx);
}

ScopedJavaLocalRef<jobject> ListSet(JNIEnv* env, const JavaRef<jobject>& list,
                                    jint idx, const JavaRef<jobject>& value) {
  return JNI_List::Java_List_set(env, list, idx, value);
}

void ListAdd(JNIEnv* env, const JavaRef<jobject>& list,
             const JavaRef<jobject>& value) {
  JNI_List::Java_List_add(env, list, value);
}

ScopedJavaLocalRef<jobject> MapGet(JNIEnv* env, const JavaRef<jobject>& map,
                                   const JavaRef<jobject>& key) {
  return JNI_Map::Java_Map_get(env, map, key);
}

ScopedJavaLocalRef<jobject> MapSet(JNIEnv* env, const JavaRef<jobject>& map,
                                   const JavaRef<jobject>& key,
                                   const JavaRef<jobject>& value) {
