...
LazyGetClass(JNIEnv* env, const char* class_name, const char* split_name,
             std::atomic<jclass>* atomic_class_id);

JNI_ZERO_COMPONENT_BUILD_EXPORT jclass LazyGetClass(
    JNIEnv* env, const char* class_name, std::atomic<jclass>* atomic_class_id);
...
// TODO(ssid): Implement for other architectures.
  ...
  JNI_ZERO_NEVER_INLINE void Init(JNIEnv* env, jclass clazz,
