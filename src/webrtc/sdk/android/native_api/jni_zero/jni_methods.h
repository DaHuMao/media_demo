...
JNI_ZERO_COMPONENT_BUILD_EXPORT ScopedJavaLocalRef<jclass> GetClass(
    JNIEnv* env, const char* class_name, const char* split_name);
JNI_ZERO_COMPONENT_BUILD_EXPORT ScopedJavaLocalRef<jclass> GetClass(
...
class JNI_ZERO_COMPONENT_BUILD_EXPORT MethodID {
 public:
  ...
  template <Type type>
  static jmethodID Get(JNIEnv* env, jclass clazz, const char* method_name,
  ...
  template <Type type>
  static jmethodID LazyGet(JNIEnv* env, jclass clazz, const char* method_name,
                           const char* jni_signature,
